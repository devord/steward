...
// The `throughput` band's behaviour, built beside kit.css and travelling the same
...
import throughputJs from "../../../../.claude/skills/widget-artifact/kit/throughput.js?raw"

import { artifactThroughputScript, artifactKitStyle } from "./theme.ts"

export const ARTIFACT_KIT_STYLE = artifactKitStyle(kitCss)
export const ARTIFACT_THROUGHPUT_SCRIPT = artifactThroughputScript(throughputJs)
