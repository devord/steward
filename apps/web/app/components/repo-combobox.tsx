  ...
  return (
    ...
    >
      <Combobox.Input
        ...
        className={cn(
          "flex h-8 w-full rounded-lg border border-input bg-transparent px-2.5 py-1 font-mono text-base outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 pointer-coarse:h-10 md:text-sm dark:bg-border/30",
          invalid &&
