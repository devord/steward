...
export const en = {
  ...
  "widget.runFailed": "run failed — click to retry",
  "widget.runCooldown": "ran just now — try again shortly",
  "widget.runCooldownIn": "ran just now — try again in {secs}s",
  "widget.runAria": "run {name} now",
