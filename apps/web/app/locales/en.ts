...
export const en = {
  ...
  "widget.chat": "Copy {name} as context for Claude",
  "widget.chatShort": "Chat with Claude",
  "widget.chatCopied": "Copied — paste it into Claude",
  ...
  "dialog.description":
    "Pick a template or describe your own widget — a routine keeps it fresh.",
  "dialog.editTitle": "Edit routine",
  "dialog.editDescription":
    "Change how this routine runs. Placement and size are set on the grid.",
  ...
  "dialog.slugFixed": "Fixed — delete and re-add to rename",
  "dialog.slugPending": "Set from the subject above",
  "dialog.customize": "Customize",
  "dialog.customizeSlugLabel": "Customize slug",
