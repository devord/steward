...
export const ptBR: Messages = {
  ...
  "widget.run": "rodar agora",
  "widget.running": "rodando…",
  "widget.runFailed": "a execução falhou — clique para tentar de novo",
  "widget.runCooldown": "acabou de rodar — tente de novo em instantes",
  "widget.runCooldownIn": "acabou de rodar — tente de novo em {secs}s",
  "widget.runAria": "rodar {name} agora",
